...
function createMajorCard(majors, gpa = null) {
    ...
    for (var l in majors) {
        ...
        $("#" + id).html("<div class='card-heading col-xs-12 col-md-4'><p class='college-heading'>" + _completeMajorMap[majors[l]]["college"] + " (" + _completeMajorMap[majors[l]]["campus"] + " campus)</p><h3 class='major-heading row'>" + _completeMajorMap[majors[l]]["major_full_nm"] + "</h3></div>");
...
function createBoxForMajor(i, median, majorId) {
    ...
    h+= "</div><div class='course-link col-xs-12'><a href='course-gpa.html?code=" + majorId + "'>&gt; View most commonly taken courses in this major</a></div>";
    $("#" + majorId).append(h);
